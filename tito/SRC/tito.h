...
typedef enum estados {
    ...
    ST_YENDOSE_POCO_POR_DERECHA = 6,
    ST_YENDOSE_MUCHO_POR_DERECHA = 8,
    ST_AFUERA_POR_DERECHA = 12,
    ST_VOLVIENDO_POR_DERECHA = 14,
    ST_VOLVIO_POR_DERECHA = 18,

    ST_YENDOSE_POCO_POR_IZQUIERDA = 20,
    ST_YENDOSE_MUCHO_POR_IZQUIERDA = 22,
    ST_AFUERA_POR_IZQUIERDA = 26,
    ST_VOLVIENDO_POR_IZQUIERDA = 28,
    ST_VOLVIO_POR_IZQUIERDA = 32,
...
#define COEFICIENTE_DERECHA 1
#define COEFICIENTE_IZQUIERDA 1
